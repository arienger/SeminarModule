codeunit 123456700 "CSD Seminar-Post"
{
    ...
    begin
        ...
        begin
            ...
            LineCount := 0; SeminarRegLine.Reset;
            SeminarRegLine.SetRange("Document No.", "No.");
    ...
    begin
        ...
        if SeminarCommentLine.FindSet then
            repeat SeminarCommentLine2 := SeminarCommentLine;
    ...
    begin
        SeminarCharge.Reset; SeminarCharge.SetRange("Document No.", FromNumber);
        if SeminarCharge.FindSet then
            repeat PstdSeminarCharge.TransferFields(SeminarCharge);
            PstdSeminarCharge."Document No." := ToNumber; PstdSeminarCharge.Insert;
    ...
    begin
        ...
        begin
            ...
            ResJnlLine."Total Cost" := ResJnlLine."Unit Cost" * ResJnlLine.Quantity; ResJnlLine."CSD Seminar No." := "Seminar No.";
        end;
        ResLedgEntry.FindLast; exit(ResLedgEntry."Entry No.");
    end;
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                SeminarJnlLine.Type := SeminarJnlLine.Type::Resource;
                SeminarJnlLine.Chargeable := false; SeminarJnlLine.Quantity := Duration;
                // Post to resource ledger SeminarJnlLine."Res. Ledger Entry No." := PostResJnlLine(Room);
            end;
